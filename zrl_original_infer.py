    ...
    with torch.no_grad():
        for batch in tqdm(loader, desc="Evaluating"):
            ...
            for t in tqdm(range(1, T), desc="Processing frames", leave=False):
                ...
                results.append((coord_pred.cpu().numpy(), np.zeros(coord_pred.shape[0], dtype=bool)))  # 没有显式 occlusion 信息
            ...
            save_sequence_results(results, sequence_result, save_path, model_name="track_on")
