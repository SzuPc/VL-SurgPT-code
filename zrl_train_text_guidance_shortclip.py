...
from load_short_clip import get_dataloader
...
def train():
    ...
    loader = get_dataloader(dataset_root, batch_size=1, folder_index=args.folder_index, clip_len=31, collate_fn=safe_collate)
    ...
    for epoch in range(num_epochs):
        ...
        ckpt_path = ckpt_dir / f"text_guidance_shortclip_checkpoint_epoch_{epoch + 1}.pt"
