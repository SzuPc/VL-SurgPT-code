    ...
    with torch.no_grad():
        ...
        for batch in tqdm(loader, desc="Evaluating"):
            ...
            for t in tqdm(range(1, T), desc="Processing frames", leave=False):
                ...
                gt_idx_all = torch.full((pred_ids.shape[0],), fill_value=-1, dtype=torch.long, device=device)
            ...
            save_path = Path("/home/lenovo/acm_mm_dataset/text_guidance_instrument_result") / case / side / seq
            save_sequence_results(results, sequence_result, save_path, model_name="track_on_text_guidance_shortclip_train")
