...
def main():
    ...
    baseline_dir = Path('/home/lenovo/acm_mm_dataset/text_guidance_instrument_result')
...
def parse_args():
    ...
    parser.add_argument('--index', type=int, default=1, help='Folder index to process, -1 means all')
    parser.add_argument('--device', type=int, default=0, help='CUDA device index')
    parser.add_argument('--model_name', default="trackon")
